...
const formacionAcademica = [
  {
    ...
    tipo: "Certificación",
    imagenes: ["/educacion/Reparacion-PC.jpg"],
  },
  {
    titulo: "Certificado en Desarrollo Web",
    institucion: "Coderhouse",
    tipo: "Certificación",
    imagenes: ["/educacion/DesarrolloWeb.png"],
  },
  {
    titulo: "Certificado en JavaScript",
    institucion: "Coderhouse",
    tipo: "Certificación",
    imagenes: ["/educacion/JS.png"],
  },
  {
    titulo: "Certificado en React",
    institucion: "Coderhouse",
    tipo: "Certificación",
    imagenes: ["/educacion/React.png"],
  },
  {
    titulo: "Certificado en Backend 1",
    institucion: "Coderhouse",
    tipo: "Certificación",
    imagenes: ["/educacion/BackEnd.png"],
  },
  {
    titulo: "Certificado en Backend 2",
    institucion: "Coderhouse",
    tipo: "Certificación",
    imagenes: ["/educacion/BackEnd2.png"],
  },
  {
    titulo: "Certificado en Backend 3",
    institucion: "Coderhouse",
    tipo: "Certificación",
    imagenes: ["/educacion/Backend3.png"],
  },
  {
